...
[![Android CI](https://github.com/slarti-zak/Alchemist-Cook/actions/workflows/android.yml/badge.svg)](https://github.com/slarti-zak/Alchemist-Cook/actions/workflows/android.yml)
...
Recipe instructions are either written using markdown or as a special dependency graph. Recipes may contain ingredients which can be directly added to a shopping list.
...
This project began as a hobby/learning project. It started as a Xamarin/C# Project many years ago. It was then rebuilt in native Android xml layouts and finally rebuilt in Android Compose. Note that not all history is kept in this git.
...
This project is meant as a learning experience. While most of it is done "by hand" as it predates the LLMs of today, it is also a way for me to test LLM features. Areas where AI was used to support the development process:

- Migrating from Couchbase to webdav
- Fixing deprecations in gradle and android library lifts
